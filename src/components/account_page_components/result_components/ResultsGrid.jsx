...
export const ResultsGrid = ({className, setContentPopup, setShowPopup, setUpdateHeaderData}) =>{
    ...
    return (<>
        <div className={`resultGrid ${className}`}>
            ...
            {examPicked ? <ResultsExamRecords variant={currentVariant} examPicked={examPicked} className={"resultGridItem4"} setContentPopup={setContentPopup} setShowPopup={setShowPopup} setUpdateHeaderData={setUpdateHeaderData}/> : 
            currentTask ? <ResultsTaskRecords variant={currentVariant} task={currentTask} className={"resultGridItem4"} setContentPopup={setContentPopup} setShowPopup={setShowPopup} setUpdateHeaderData={setUpdateHeaderData}/> : 
