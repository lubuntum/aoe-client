...
export const SectionBanner = () => {
    ...
    return (<>
        <section className="main_banner_section">
            ...
            <h4 className="main_banner_subtitle">Наш сервис создает атмосферу настоящего экзамена, помогая тебе уверенно чувствовать себя на ЕГЭ. Улучшай свои навыки говорения и добивайся максимальных результатов ЕГЭ вмести с нами!</h4>
