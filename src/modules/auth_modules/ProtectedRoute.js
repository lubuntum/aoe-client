...
const unAuthRoutesAccess = [routes.HOME, routes.AUTORIZATION, routes.TASK, routes.RESULTS, routes.TASK_RESULT, routes.LESSON_SESSION]
const ProtectedRoute = ({component}) => {
    ...
    if((location.pathname === routes.AUTORIZATION) && isAuth)
