const SUCCESS_REG_COMPLETE = {
    message: "Регистрация успешна! Мы отправили вам сообщение на почту для подтверждения аккаунта.",
    type: "success"
};
...
const SUCCESS_FORGET_EMAIL_SEND = {
    message: "На вашу почту была отправлена ссылка на сброс пароля.",
    type: "success"
};
