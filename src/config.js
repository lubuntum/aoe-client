...
//Линк сервера
export const SERVER_API_URL = "http://172.31.38.111:8080"
//Роуты для валидации
...
export const API_ADMIN_EDIT_VARIANT = "/api/admin/edit-variant/%d"
export const API_ADMIN_EDIT_VARIANT_TASKS = "/api/admin/edit-variant-tasks/%d"
